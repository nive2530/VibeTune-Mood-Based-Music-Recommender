...
try:
    ...
    for record in songs.to_dict(orient='records'):
        try:
            result = producer.send('songs', record).get(timeout=60)
    ...
    print("Error: songs_features.csv not found.")
except Exception as e:
